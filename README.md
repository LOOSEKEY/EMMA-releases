...
>
> **The current release (1.3.0) has no Mac build yet.** Windows and Linux are on
> 1.3.0; macOS is on **1.0.1**, which is a complete release with both Mac files
...
>
> EMMA may offer you the 1.3.0 update and then tell you there is no installer
...
- **1.3.0 is the biggest release since 1.0.** She speaks **German and Dutch**;
  ...
  ChatGPT or Claude. The [release notes](../../releases/tag/v1.3.0) have all of it.
...
- **macOS is behind, again.** Windows and Linux are on **1.3.0**;
