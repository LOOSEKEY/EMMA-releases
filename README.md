...
>
> **The current release (1.2.7) has no Mac build.** Windows and Linux are on
> 1.2.7; macOS is on **1.0.1**, which is a complete release with both Mac files
...
>
> EMMA may offer you the 1.2.7 update and then tell you there is no installer
...
- **macOS is behind, again.** Windows and Linux are on **1.2.7**;
