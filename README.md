...
>
> **The current release (1.3.1) has no Mac build yet.** Windows and Linux are on
> 1.3.1; macOS is on **1.0.1**, which is a complete release with both Mac files
...
>
> EMMA may offer you the 1.3.1 update and then tell you there is no installer
...
- **New in 1.3.1: a calendar, both ways.** Press *calendar* at the top, or just
  ...
  encrypted with the rest of her memory. The bin moved to beside the chat box,
  questions about your calendar or inbox now always reach them, and dates that
  failed on Windows in a few places are fixed. The
  [release notes](../../releases/tag/v1.3.1) have the details.
- **1.3.0 was the biggest release since 1.0.** She speaks **German and Dutch**;
  ...
  ChatGPT or Claude. All of it is in 1.3.1 too.
...
- **macOS is behind, again.** Windows and Linux are on **1.3.1**;
